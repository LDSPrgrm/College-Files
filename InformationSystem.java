...
public class InformationSystem {
    ...
    public static void show_students() throws Exception {
        ...
        System.out.println("\n======================");
        System.out.println(" [1] SHOW PAGE NUMBER");
    ...
    public static void delete_this_student(String studentID) throws Exception {
        clrscr();
    ...
    public static void show_student_subjects(String studentID, String name) throws IOException {
        ...
        System.out.println("\n==================================");
        System.out.println(" [1] ADD SUBJECTS TO THIS STUDENT");
        System.out.println(" [2] ENTER STUDENT'S GRADES");
        System.out.println(" [3] BACK");
        System.out.println("==================================");
        ...
        try {
            ...
            while (menu != -1) {
                if (menu == 1) {
                    add_student_subjects(studentID);
                }
                if (menu == 2) {
    ...
    public static void enter_grades(String studentID, String name) throws IOException{
        ...
        while (true) {
            ...
            while ((lines = br.readLine()) != null) {
                ...
                if (studentID.equals(values[0]) && code.equalsIgnoreCase(values[1])){
                    subject = values[2];
                    instructor = values[3];
                }
            }
        ...
        String gradePattern = "^(?:100(?:\\.0{1,2})?|[1-9]?\\d(?:\\.\\d{1,2})?|0\\.\\d{1,2})$";
        while (true) {
            System.out.print("\nEnter prelims grade (Enter '0.00' if none): ");
        ...
        while (true) {
            System.out.print("Enter midterms grade (Enter '0.00' if none): ");
        ...
        while (true) {
            System.out.print("Enter finals grade (Enter '0.00' if none): ");
        ...
        for (int i = 0; i < studentSubjects.size(); i++) {
            if (studentSubjects.get(i).getID().equals(studentID) && studentSubjects.get(i).getCode().equalsIgnoreCase(code)){
    ...
    public static void add_student_subjects(String studentID) throws IOException {
        clrscr();
        BufferedReader br = new BufferedReader(new FileReader("StudentSubjects.csv"));
    ...
    public static void options(String studentID, String name) {
        clrscr();
        System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("| %-7s | %-15s | %-15s | %-15s | %-40s | %-10s | %-6s | %-15s | %-40s |\n", studentToEdit.getID(), studentToEdit.getLastName(), studentToEdit.getFirstName(), studentToEdit.getMiddleName(), studentToEdit.getAddress(), studentToEdit.getCourse(), studentToEdit.getGender(), studentToEdit.getPhone(), studentToEdit.getEmail());
        System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");

        System.out.println("\n==========================================");
        System.out.println(" [1] EDIT STUDENT'S PERSONAL INFORMATIONS");
        System.out.println(" [2] DELETE THIS STUDENT");
        System.out.println(" [3] SHOW STUDENT'S SUBJECTS");
...
class Student {
    private String id, lastName, firstName, middleName, course, gender, phone, email, address;
